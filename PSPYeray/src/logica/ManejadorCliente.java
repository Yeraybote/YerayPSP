        ...
        try (
            ...
            try {
                ...
                if (objeto instanceof LoginRequest) {
                    System.out.println("LoginRequest recibido");
                    // Procesar Login
                    ...
                    this.clavePublica = (PublicKey) objeto;
                    System.out.println("Clave pública recibida: " + clavePublica);

                    //salida.writeObject("CLAVE_PUBLICA_OK");
                }
                else {
